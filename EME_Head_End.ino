...
void setup() {
  ...
  */
  ...
  Serial.print("Ethernet DNS Server: ");
...
void loop() {
  ...
  int ampSensor = analogRead(A6);
  int sinkSensor = analogRead(A3);
        ...
        if (requestStatus == 3) {
          switch (c) {
            case 'r': //report status
              reportText = "airTemp=";
              reportValue = String(airSensor);
              reportText += reportValue;
              reportText += ";";
              reportText += "sinkTemp=";
              reportValue = String(sinkSensor);
              reportText += reportValue;
              reportText += ";";
              reportText += "ampPower=";
              reportValue = String(ampSensor);
              reportText += reportValue;
              reportText += ";";
